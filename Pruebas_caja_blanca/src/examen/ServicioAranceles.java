...
/**
 * Servicio que permite calcular aranceles sobre productos importados, en
 * función del país de origen y la categoría del producto.
 */
public class ServicioAranceles {
	...
	/**
	 * Calcula el arancel total a aplicar a un producto importado. Tiene en cuenta
	 * el país de origen y la categoría. Si alguno no se encuentra en el sistema, se
	 * usa una tasa por defecto.
	 *
